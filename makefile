...
USER_CFLAGS = -Isrc/ofxWidgets/src -Isrc/ofxKinect/src -I/usr/include/libusb-1.0 -Isrc/ofxKinect/libs/libfreenect -Isrc/ofxTween/src -Isrc/ofxTween/src/Easings
USER_LD_FLAGS = 
USER_LIBS = -lusb-1.0
